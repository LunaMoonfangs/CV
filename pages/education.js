    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.educationItem}>
            ...
            <div>
              <a href="https://inginerie.ulbsibiu.ro/scccdp/" target="_blank" rel="noreferrer">CAM,CAM,CAE - Lucian Blaga University of Sibiu</a>
            </div>
        </div>
        <div className={styles.educationItem}>
            2006 - 2010 Machine Tools and Production Systems
            <div>
              <a href="https://inginerie.ulbsibiu.ro/wp-content/uploads/2018/06/Plan-de-Invatamant-MUSP-21_05_2018.pdf" target="_blank" rel="noreferrer"> MUSP - Lucian Blaga University of Sibiu</a>
            </div>
        </div>
        <div className={styles.educationItem}>
